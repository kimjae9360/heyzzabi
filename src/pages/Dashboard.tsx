...
const TREND_DATA = [
  { week: '7/W1', meetings: 3, proposals: 2, tasks: 8, shipped: 6 },
  { week: '7/W2', meetings: 5, proposals: 4, tasks: 15, shipped: 10 },
  { week: '7/W3', meetings: 4, proposals: 3, tasks: 12, shipped: 9 },
  { week: '7/W4', meetings: 6, proposals: 5, tasks: 20, shipped: 14 },
  { week: '8/W1', meetings: 7, proposals: 6, tasks: 24, shipped: 18 },
  { week: '8/W2', meetings: 4, proposals: 3, tasks: 11, shipped: 7 },
];
      ...
      <div className="p-6 max-w-7xl mx-auto w-full space-y-5">
        ...
        <div className="grid grid-cols-4 gap-4">
          {[
            ...
            <Link key={i} to={k.link} className={cn(
            ...
            {pipelineStatusData.length > 0 ? (
              ...
              <div className="h-40 flex items-center justify-center text-gray-400 text-xs text-center">
                <div>
                  ...
                  <p>파이프라인에 업무가 없습니다.</p>
                  <Link to="/meetings" className="text-blue-500 font-bold hover:underline text-[10px]">회의록 등록하기 →</Link>
                </div>
              </div>
            )}
          </div>
          ...
          <div className="col-span-2 bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
            ...
            <div className="divide-y divide-gray-100">
              {recentActivity.length === 0 ? (
                ...
                <Link key={n.id} to={n.link || '/dashboard'} className="flex items-start gap-3 px-5 py-3 hover:bg-gray-50 transition-colors">
          ...
          <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
            ...
            <div className="p-4 space-y-2">
              {[
                ...
                <Link key={i} to={item.link} className={cn(
