...
export default function Meetings() {
  ...
  const handleAddMeeting = (e: React.FormEvent) => {
    ...
    addMeeting({ title: newTitle, date: now, summary: newContent.split('\n').filter(Boolean) });
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                  ...
                  {selectedMeeting.isTasksExtracted && (
                    <div className="border-t border-emerald-100 p-5 bg-emerald-50 flex items-center justify-between">
                      ...
                      <Link to="/pipeline" className="text-xs font-bold text-emerald-700 bg-white px-3 py-1.5 rounded-lg border border-emerald-200 hover:bg-emerald-50 transition-colors flex items-center gap-1">
